...
var creatorList = ['@kanvret','@zahirrr','@zhirrrgans','@zhirr_ajalah','@zahiranjay', '@kanvretsss','@zhirrganteng','@zahirrgantengg', '@hafizh'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/6281546767920 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, gak punya apikey? chat gw aja yaaa di wa.me/6281546767920 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------KANVRET'+'KANVRETT';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'kanvret') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'kanvret') return res.json(loghandler.invalidKey)
